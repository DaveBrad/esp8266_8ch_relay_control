...
//
////      SerialEmu serialEmu;
//      //      processRlyOxxxxx(client, serialEmu, request, relayOperateIndex, tcpAccessed);
...
//// ------------ relay get actions ------------
////
////void processRlyOxxxxx(WiFiClient client, SerialEmu serialEmu, String request, int rlyEqualIndex, int accessKind) {
