...
//
//
//      Serial.println("line 409");
//
//      //      SerialEmu serialEmu = SerialEmu();
//      //
//      //       Serial.println("line 410");
//      //
//      //      processRlyOxxxxx(serialEmu, request, relayOperateIndex, tcpAccessed);
//      //      //      processRlyOxxxxx(client, request, relayOperateIndex, tcpAccessed);
//      //
//      //      client.print(serialEmu.toString());
//
...
//    HttpCtrl::respondHttp200(client, "text/plain");
//
//    Serial.println("line 590");
//    SerialEmu serialEmu; // = SerialEmu();
//
//    
//    Serial.println("line 592");
//    processRlyOxxxxx(client, serialEmu, path, relayOperateIndex, httpAccessed);
//    //    processRlyOxxxxx(client, path, relayOperateIndex, httpAccessed);
//
//    Serial.println("line 596");
//
////    String test = serialEmu.toString();
////    Serial.print(test);
//
////    client.print(serialEmu.toString());
//
...
////
//// WiFiClient client
//void processRlyOxxxxx(WiFiClient client,
//                      SerialEmu serialEmu,
...
//  if (intOfNval == -2) {
////    serialEmu.print("=A");
////    serialEmu.print(onOffQuery);  // 'N' of 'F'
//        client.print("=A");
